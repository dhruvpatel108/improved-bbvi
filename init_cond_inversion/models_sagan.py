...
class Generator(nn.Module):
    ...
    def __init__(self, batch_size, image_size=32, z_dim=100, conv_dim=64):
        ...
        last.append(nn.ConvTranspose2d(64, 1, 4, 2, 1))
        last.append(nn.Tanh())
...
class Discriminator(nn.Module):
    ...
    def __init__(self, batch_size=64, image_size=32, conv_dim=64):
