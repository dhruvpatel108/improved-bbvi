...
class Likelihood():
    ...
    def log_likelihood_batch(self, z):
        ...
        batched_y_pred = pred_y_from_z(z, config.generator, config.cnn, config.min_value, config.max_value, self.batch_size, config.box_z_dim, config.box_x_dim)
    ...
    def log_likelihood_sample(self, z):
        ...
        y_pred = pred_y_from_z(z, config.generator, config.cnn, config.min_value, config.max_value, 1, config.box_z_dim, config.box_x_dim)
