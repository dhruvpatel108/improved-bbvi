...
class Likelihood():
    def __init__(self, y_meas, batched_y_meas, forward_model, like_var_vec, batched_like_var_vec):
        self.y_meas = y_meas
    ...
    def log_likelihood_batch(self, x):
        ...
        res = self.batched_y_meas - self.forward_model(x)
    ...
    def log_likelihood_sample(self, x):
        ...
        res = self.y_meas - self.forward_model(x)
